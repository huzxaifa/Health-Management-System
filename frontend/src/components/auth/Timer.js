...
import './Timer.css'; // Make sure to import the necessary CSS file
...
const Timer = () => {
  ...
  <div class="card2">
    <div class="upper">
      <div class="humidity">
        <div class="humiditytext">Humidity<br></br>30%</div>
      ...
      <div class="air">
        <div class="airtext">Wind<br></br>8 Km/h</div>
    ...
    <div class="lower">
      <div class="aqi">
        ...
        <div class="aqitext">AQI<br></br>30</div>
      </div>
      ...
      <div class="realfeel">
        ...
        <div class="realfeeltext">Real Feel<br></br>21 °C</div>
      </div>
      ...
      <div class="pressure">
        ...
        <div class="pressuretext">Pressure<br></br>1012 mbar</div>
      </div>
      <div class="card3">
      Healthy
      </div>
